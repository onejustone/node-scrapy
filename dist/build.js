...
function ajaxGet(url$$1, headers) {
    if (headers === void 0) {
        headers = null;
    }
    return new AjaxObservable({ method: 'GET', url: url$$1, headers: headers });
}
function ajaxPost(url$$1, body, headers) {
    return new AjaxObservable({ method: 'POST', url: url$$1, body: body, headers: headers });
}
function ajaxDelete(url$$1, headers) {
    return new AjaxObservable({ method: 'DELETE', url: url$$1, headers: headers });
}
function ajaxPut(url$$1, body, headers) {
    return new AjaxObservable({ method: 'PUT', url: url$$1, body: body, headers: headers });
}
function ajaxPatch(url$$1, body, headers) {
    return new AjaxObservable({ method: 'PATCH', url: url$$1, body: body, headers: headers });
}
var mapResponse = /*@__PURE__*/ map(function (x, index) { return x.response; });
function ajaxGetJSON(url$$1, headers) {
...
var AjaxSubscriber = /*@__PURE__*/ (function (_super) {
    ...
    AjaxSubscriber.prototype.send = function () {
        ...
        if (xhr === errorObject) {
            ...
            var result = void 0;
            if (user) {
                result = tryCatch(xhr.open).call(xhr, method, url$$1, async, user, password);
            }
            else {
                result = tryCatch(xhr.open).call(xhr, method, url$$1, async);
            }
...
var WebSocketSubject = /*@__PURE__*/ (function (_super) {
    ...
    WebSocketSubject.prototype._connectSocket = function () {
        var _this = this;
        var _a = this._config, WebSocketCtor = _a.WebSocketCtor, protocol = _a.protocol, url$$1 = _a.url, binaryType = _a.binaryType;
        var observer = this._output;
        var socket = null;
        try {
            socket = protocol ?
                new WebSocketCtor(url$$1, protocol) :
                new WebSocketCtor(url$$1);
            this._socket = socket;
            if (binaryType) {
...
var bindCallback$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.bindCallback = _esm5.bindCallback;

});

unwrapExports(bindCallback$1);

var bindNodeCallback$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.bindNodeCallback = _esm5.bindNodeCallback;

});

unwrapExports(bindNodeCallback$1);

var combineLatest$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.combineLatest = _esm5.combineLatest;
...
_esm5.Observable.concat = _esm5.concat;
...
_esm5.Observable.defer = _esm5.defer;

});

unwrapExports(defer$1);

var empty$2 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.empty = _esm5.empty;

});

unwrapExports(empty$2);

var forkJoin$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.forkJoin = _esm5.forkJoin;
...
_esm5.Observable.fromEvent = _esm5.fromEvent;

});

unwrapExports(fromEvent$1);

var fromEventPattern$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.fromEventPattern = _esm5.fromEventPattern;

});

unwrapExports(fromEventPattern$1);

var fromPromise$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.fromPromise = _esm5.from;
...
_esm5.Observable.generate = _esm5.generate;

});

unwrapExports(generate$1);

var _if = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.if = _esm5.iif;
...
_esm5.Observable.interval = _esm5.interval;
...
_esm5.Observable.merge = _esm5.merge;
...
_esm5.Observable.race = _esm5.race;
...
_esm5.Observable.never = staticNever;

});

unwrapExports(never$1);
var never_1 = never$1.staticNever;

var of$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.of = _esm5.of;
...
_esm5.Observable.onErrorResumeNext = _esm5.onErrorResumeNext;
...
_esm5.Observable.pairs = _esm5.pairs;
...
_esm5.Observable.range = _esm5.range;

});

unwrapExports(range$1);

var using$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.using = _esm5.using;

});

unwrapExports(using$1);

var _throw = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

_esm5.Observable.throw = _esm5.throwError;
_esm5.Observable.throwError = _esm5.throwError;
...
_esm5.Observable.timer = _esm5.timer;
...
_esm5.Observable.zip = _esm5.zip;
...
_esm5.Observable.ajax = ajax$1.ajax;
...
_esm5.Observable.webSocket = webSocket$1.webSocket;
 ...
 */
function buffer(closingNotifier) {
    return operators.buffer(closingNotifier)(this);
}
...
_esm5.Observable.prototype.buffer = buffer_1.buffer;
...
function bufferCount(bufferSize, startBufferEvery) {
    ...
    return operators.bufferCount(bufferSize, startBufferEvery)(this);
}
...
_esm5.Observable.prototype.bufferCount = bufferCount_1.bufferCount;
...
function bufferTime(bufferTimeSpan) {
    var length = arguments.length;
    var scheduler = _esm5.asyncScheduler;
    if (internalCompatibility.isScheduler(arguments[arguments.length - 1])) {
        scheduler = arguments[arguments.length - 1];
        length--;
    }
    var bufferCreationInterval = null;
    ...
    return operators.bufferTime(bufferTimeSpan, bufferCreationInterval, maxBufferSize, scheduler)(this);
}
...
_esm5.Observable.prototype.bufferTime = bufferTime_1.bufferTime;
 ...
 */
function bufferToggle(openings, closingSelector) {
    return operators.bufferToggle(openings, closingSelector)(this);
}
...
_esm5.Observable.prototype.bufferToggle = bufferToggle_1.bufferToggle;
 ...
 */
function bufferWhen(closingSelector) {
    return operators.bufferWhen(closingSelector)(this);
}
...
_esm5.Observable.prototype.bufferWhen = bufferWhen_1.bufferWhen;
...
function _catch(selector) {
    return operators.catchError(selector)(this);
}
...
_esm5.Observable.prototype.catch = _catch_1._catch;
_esm5.Observable.prototype._catch = _catch_1._catch;
 ...
 */
function combineAll(project) {
    return operators.combineAll(project)(this);
}
...
_esm5.Observable.prototype.combineAll = combineAll_1.combineAll;
...
function combineLatest() {
    ...
    if (observables.length === 1 && internalCompatibility.isArray(observables[0])) {
        observables = observables[0].slice();
    }
    return this.lift.call(_esm5.of.apply(void 0, [this].concat(observables)), new internalCompatibility.CombineLatestOperator(project));
}
...
var combineLatest$5 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });


_esm5.Observable.prototype.combineLatest = combineLatest_1.combineLatest;

});

unwrapExports(combineLatest$5);
...
function concat() {
    ...
    return this.lift.call(_esm5.concat.apply(void 0, [this].concat(observables)));
}
...
_esm5.Observable.prototype.concat = concat_1.concat;

});

unwrapExports(concat$5);
 ...
 */
function concatAll() {
    return operators.concatAll()(this);
}
...
_esm5.Observable.prototype.concatAll = concatAll_1.concatAll;
...
function concatMap(project) {
    return operators.concatMap(project)(this);
}
...
_esm5.Observable.prototype.concatMap = concatMap_1.concatMap;
...
function concatMapTo(innerObservable) {
    return operators.concatMapTo(innerObservable)(this);
}
...
_esm5.Observable.prototype.concatMapTo = concatMapTo_1.concatMapTo;
 ...
 */
function count(predicate) {
    return operators.count(predicate)(this);
}
exports.count = count;
...
_esm5.Observable.prototype.count = count_1.count;
 ...
 */
function dematerialize() {
    return operators.dematerialize()(this);
}
...
_esm5.Observable.prototype.dematerialize = dematerialize_1.dematerialize;
 ...
 */
function debounce(durationSelector) {
    return operators.debounce(durationSelector)(this);
}
...
_esm5.Observable.prototype.debounce = debounce_1.debounce;
 ...
 */
function debounceTime(dueTime, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.debounceTime(dueTime, scheduler)(this);
}
...
_esm5.Observable.prototype.debounceTime = debounceTime_1.debounceTime;
...
function defaultIfEmpty(defaultValue) {
    ...
    return operators.defaultIfEmpty(defaultValue)(this);
}
...
_esm5.Observable.prototype.defaultIfEmpty = defaultIfEmpty_1.defaultIfEmpty;
...
function delay(delay, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.delay(delay, scheduler)(this);
}
exports.delay = delay;
...
_esm5.Observable.prototype.delay = delay_1.delay;
 ...
 */
function delayWhen(delayDurationSelector, subscriptionDelay) {
    return operators.delayWhen(delayDurationSelector, subscriptionDelay)(this);
}
...
_esm5.Observable.prototype.delayWhen = delayWhen_1.delayWhen;
 ...
 */
function distinct(keySelector, flushes) {
    return operators.distinct(keySelector, flushes)(this);
}
...
_esm5.Observable.prototype.distinct = distinct_1.distinct;
 ...
 */
function distinctUntilChanged(compare, keySelector) {
    return operators.distinctUntilChanged(compare, keySelector)(this);
}
...
_esm5.Observable.prototype.distinctUntilChanged = distinctUntilChanged_1.distinctUntilChanged;
...
_esm5.Observable.prototype.distinctUntilKeyChanged = distinctUntilKeyChanged_1.distinctUntilKeyChanged;
...
function _do(nextOrObserver, error, complete) {
    return operators.tap(nextOrObserver, error, complete)(this);
}
exports._do = _do;
...
_esm5.Observable.prototype.do = _do_1._do;
_esm5.Observable.prototype._do = _do_1._do;
...
_esm5.Observable.prototype.exhaust = exhaust_1.exhaust;
...
function exhaustMap(project) {
    return operators.exhaustMap(project)(this);
}
...
_esm5.Observable.prototype.exhaustMap = exhaustMap_1.exhaustMap;
...
function expand(project, concurrent, scheduler) {
    ...
    concurrent = (concurrent || 0) < 1 ? Number.POSITIVE_INFINITY : concurrent;
    return operators.expand(project, concurrent, scheduler)(this);
}
...
_esm5.Observable.prototype.expand = expand_1.expand;
 ...
 */
function elementAt(index, defaultValue) {
    return operators.elementAt.apply(undefined, arguments)(this);
}
...
_esm5.Observable.prototype.elementAt = elementAt_1.elementAt;
 ...
 */
function filter(predicate, thisArg) {
    return operators.filter(predicate, thisArg)(this);
}
...
function _finally(callback) {
    return operators.finalize(callback)(this);
}
...
_esm5.Observable.prototype.finally = _finally_1._finally;
_esm5.Observable.prototype._finally = _finally_1._finally;
 ...
 */
function find(predicate, thisArg) {
    return operators.find(predicate, thisArg)(this);
}
exports.find = find;
...
_esm5.Observable.prototype.find = find_1.find;
 ...
 */
function findIndex(predicate, thisArg) {
    return operators.findIndex(predicate, thisArg)(this);
}
...
_esm5.Observable.prototype.findIndex = findIndex_1.findIndex;
...
function first() {
    ...
    return operators.first.apply(void 0, args)(this);
}
exports.first = first;
...
_esm5.Observable.prototype.first = first_1.first;
 ...
 */
function groupBy(keySelector, elementSelector, durationSelector, subjectSelector) {
    return operators.groupBy(keySelector, elementSelector, durationSelector, subjectSelector)(this);
}
...
_esm5.Observable.prototype.groupBy = groupBy_1.groupBy;
 ...
 */
function ignoreElements() {
    return operators.ignoreElements()(this);
}
...
_esm5.Observable.prototype.ignoreElements = ignoreElements_1.ignoreElements;
...
_esm5.Observable.prototype.isEmpty = isEmpty_1.isEmpty;
 ...
 */
function audit(durationSelector) {
    return operators.audit(durationSelector)(this);
}
exports.audit = audit;
...
_esm5.Observable.prototype.audit = audit_1.audit;
...
function auditTime(duration, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.auditTime(duration, scheduler)(this);
}
...
_esm5.Observable.prototype.auditTime = auditTime_1.auditTime;
...
function last() {
    ...
    return operators.last.apply(void 0, args)(this);
}
exports.last = last;
...
_esm5.Observable.prototype.last = last_1.last;
...
_esm5.Observable.prototype.let = _let.letProto;
_esm5.Observable.prototype.letBind = _let.letProto;
 ...
 */
function every(predicate, thisArg) {
    return operators.every(predicate, thisArg)(this);
}
exports.every = every;
...
_esm5.Observable.prototype.every = every_1.every;
 ...
 */
function map(project, thisArg) {
    return operators.map(project, thisArg)(this);
}
exports.map = map;
 ...
 */
function mapTo(value) {
    return operators.mapTo(value)(this);
}
exports.mapTo = mapTo;
...
_esm5.Observable.prototype.mapTo = mapTo_1.mapTo;
 ...
 */
function materialize() {
    return operators.materialize()(this);
}
...
_esm5.Observable.prototype.materialize = materialize_1.materialize;
 ...
 */
function max(comparer) {
    return operators.max(comparer)(this);
}
exports.max = max;
...
_esm5.Observable.prototype.max = max_1.max;
...
function merge() {
    ...
    return this.lift.call(_esm5.merge.apply(void 0, [this].concat(observables)));
}
exports.merge = merge;
...
var merge$6 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });


_esm5.Observable.prototype.merge = merge_1.merge;

});

unwrapExports(merge$6);
...
function mergeAll(concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return operators.mergeAll(concurrent)(this);
}
...
_esm5.Observable.prototype.mergeAll = mergeAll_1.mergeAll;
...
function mergeMap(project, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return operators.mergeMap(project, concurrent)(this);
}
...
_esm5.Observable.prototype.mergeMap = mergeMap_1.mergeMap;
_esm5.Observable.prototype.flatMap = mergeMap_1.mergeMap;
...
function mergeMapTo(innerObservable, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return operators.mergeMapTo(innerObservable, concurrent)(this);
}
...
_esm5.Observable.prototype.flatMapTo = mergeMapTo_1.mergeMapTo;
_esm5.Observable.prototype.mergeMapTo = mergeMapTo_1.mergeMapTo;
...
function mergeScan(accumulator, seed, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return operators.mergeScan(accumulator, seed, concurrent)(this);
}
...
_esm5.Observable.prototype.mergeScan = mergeScan_1.mergeScan;
 ...
 */
function min(comparer) {
    return operators.min(comparer)(this);
}
exports.min = min;
...
_esm5.Observable.prototype.min = min_1.min;
 ...
 */
function multicast(subjectOrSubjectFactory, selector) {
    return operators.multicast(subjectOrSubjectFactory, selector)(this);
}
...
_esm5.Observable.prototype.multicast = multicast_1.multicast;
...
function observeOn(scheduler, delay) {
    ...
    return operators.observeOn(scheduler, delay)(this);
}
...
_esm5.Observable.prototype.observeOn = observeOn_1.observeOn;
...
function onErrorResumeNext() {
    ...
    return operators.onErrorResumeNext.apply(void 0, nextSources)(this);
}
...
_esm5.Observable.prototype.onErrorResumeNext = onErrorResumeNext_1.onErrorResumeNext;
 ...
 */
function pairwise() {
    return operators.pairwise()(this);
}
...
_esm5.Observable.prototype.pairwise = pairwise_1.pairwise;
 ...
 */
function partition(predicate, thisArg) {
    return operators.partition(predicate, thisArg)(this);
}
...
_esm5.Observable.prototype.partition = partition_1.partition;
...
function pluck() {
    ...
    return operators.pluck.apply(void 0, properties)(this);
}
exports.pluck = pluck;
...
_esm5.Observable.prototype.pluck = pluck_1.pluck;
 ...
 */
function publish(selector) {
    return operators.publish(selector)(this);
}
...
_esm5.Observable.prototype.publish = publish_1.publish;
 ...
 */
function publishBehavior(value) {
    return operators.publishBehavior(value)(this);
}
...
_esm5.Observable.prototype.publishBehavior = publishBehavior_1.publishBehavior;
 ...
 */
function publishReplay(bufferSize, windowTime, selectorOrScheduler, scheduler) {
    return operators.publishReplay(bufferSize, windowTime, selectorOrScheduler, scheduler)(this);
}
...
_esm5.Observable.prototype.publishReplay = publishReplay_1.publishReplay;
...
function publishLast() {
    ...
    return operators.publishLast()(this);
}
...
_esm5.Observable.prototype.publishLast = publishLast_1.publishLast;
...
function race() {
    ...
    return operators.race.apply(void 0, observables)(this);
}
exports.race = race;
...
_esm5.Observable.prototype.race = race_1.race;
...
function reduce(accumulator, seed) {
    ...
    if (arguments.length >= 2) {
        return operators.reduce(accumulator, seed)(this);
    }
    return operators.reduce(accumulator)(this);
}
...
_esm5.Observable.prototype.reduce = reduce_1.reduce;
...
function repeat(count) {
    ...
    return operators.repeat(count)(this);
}
...
_esm5.Observable.prototype.repeat = repeat_1.repeat;
 ...
 */
function repeatWhen(notifier) {
    return operators.repeatWhen(notifier)(this);
}
...
_esm5.Observable.prototype.repeatWhen = repeatWhen_1.repeatWhen;
...
function retry(count) {
    if (count === void 0) { count = -1; }
    return operators.retry(count)(this);
}
exports.retry = retry;
...
_esm5.Observable.prototype.retry = retry_1.retry;
 ...
 */
function retryWhen(notifier) {
    return operators.retryWhen(notifier)(this);
}
...
_esm5.Observable.prototype.retryWhen = retryWhen_1.retryWhen;
 ...
 */
function sample(notifier) {
    return operators.sample(notifier)(this);
}
...
_esm5.Observable.prototype.sample = sample_1.sample;
...
function sampleTime(period, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.sampleTime(period, scheduler)(this);
}
...
_esm5.Observable.prototype.sampleTime = sampleTime_1.sampleTime;
...
function scan(accumulator, seed) {
    if (arguments.length >= 2) {
        return operators.scan(accumulator, seed)(this);
    }
    return operators.scan(accumulator)(this);
}
exports.scan = scan;
...
_esm5.Observable.prototype.scan = scan_1.scan;
 ...
 */
function sequenceEqual(compareTo, comparor) {
    return operators.sequenceEqual(compareTo, comparor)(this);
}
...
_esm5.Observable.prototype.sequenceEqual = sequenceEqual_1.sequenceEqual;
...
_esm5.Observable.prototype.share = share_1.share;
 ...
 */
function shareReplay(bufferSize, windowTime, scheduler) {
    return operators.shareReplay(bufferSize, windowTime, scheduler)(this);
}
...
_esm5.Observable.prototype.shareReplay = shareReplay_1.shareReplay;
 ...
 */
function single(predicate) {
    return operators.single(predicate)(this);
}
...
_esm5.Observable.prototype.single = single_1.single;
 ...
 */
function skip(count) {
    return operators.skip(count)(this);
}
exports.skip = skip;
...
_esm5.Observable.prototype.skip = skip_1.skip;
 ...
 */
function skipLast(count) {
    return operators.skipLast(count)(this);
}
...
_esm5.Observable.prototype.skipLast = skipLast_1.skipLast;
 ...
 */
function skipUntil(notifier) {
    return operators.skipUntil(notifier)(this);
}
...
_esm5.Observable.prototype.skipUntil = skipUntil_1.skipUntil;
 ...
 */
function skipWhile(predicate) {
    return operators.skipWhile(predicate)(this);
}
...
_esm5.Observable.prototype.skipWhile = skipWhile_1.skipWhile;
...
function startWith() {
    ...
    return operators.startWith.apply(void 0, array)(this);
}
...
_esm5.Observable.prototype.startWith = startWith_1.startWith;
...
function subscribeOn(scheduler, delay) {
    if (delay === void 0) { delay = 0; }
    return operators.subscribeOn(scheduler, delay)(this);
}
...
_esm5.Observable.prototype.subscribeOn = subscribeOn_1.subscribeOn;
 ...
 */
function _switch() {
    return operators.switchAll()(this);
}
...
_esm5.Observable.prototype.switch = _switch_1._switch;
_esm5.Observable.prototype._switch = _switch_1._switch;
...
function switchMap(project) {
    return operators.switchMap(project)(this);
}
...
_esm5.Observable.prototype.switchMap = switchMap_1.switchMap;
...
function switchMapTo(innerObservable) {
    return operators.switchMapTo(innerObservable)(this);
}
...
_esm5.Observable.prototype.switchMapTo = switchMapTo_1.switchMapTo;
 ...
 */
function take(count) {
    return operators.take(count)(this);
}
exports.take = take;
 ...
 */
function takeLast(count) {
    return operators.takeLast(count)(this);
}
...
_esm5.Observable.prototype.takeLast = takeLast_1.takeLast;
 ...
 */
function takeUntil(notifier) {
    return operators.takeUntil(notifier)(this);
}
...
_esm5.Observable.prototype.takeUntil = takeUntil_1.takeUntil;
 ...
 */
function takeWhile(predicate) {
    return operators.takeWhile(predicate)(this);
}
...
_esm5.Observable.prototype.takeWhile = takeWhile_1.takeWhile;
 ...
 */
function throttle(durationSelector, config) {
    if (config === void 0) { config = internalCompatibility.defaultThrottleConfig; }
    return operators.throttle(durationSelector, config)(this);
}
...
var throttle_2 = throttle_1.throttle;

var throttle$2 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });


_esm5.Observable.prototype.throttle = throttle_1.throttle;
...
function throttleTime(duration, scheduler, config) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    if (config === void 0) { config = internalCompatibility.defaultThrottleConfig; }
    return operators.throttleTime(duration, scheduler, config)(this);
}
...
_esm5.Observable.prototype.throttleTime = throttleTime_1.throttleTime;
...
function timeInterval(scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.timeInterval(scheduler)(this);
}
...
_esm5.Observable.prototype.timeInterval = timeInterval_1.timeInterval;
...
function timeout(due, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.timeout(due, scheduler)(this);
}
...
_esm5.Observable.prototype.timeout = timeout_1.timeout;
...
function timeoutWith(due, withObservable, scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.timeoutWith(due, withObservable, scheduler)(this);
}
...
_esm5.Observable.prototype.timeoutWith = timeoutWith_1.timeoutWith;
...
function timestamp(scheduler) {
    if (scheduler === void 0) { scheduler = _esm5.asyncScheduler; }
    return operators.timestamp(scheduler)(this);
}
...
_esm5.Observable.prototype.timestamp = timestamp_1.timestamp;
...
_esm5.Observable.prototype.toArray = toArray_1.toArray;
...
function window(windowBoundaries) {
    return operators.window(windowBoundaries)(this);
}
...
_esm5.Observable.prototype.window = window_1.window;
...
function windowCount(windowSize, startWindowEvery) {
    ...
    return operators.windowCount(windowSize, startWindowEvery)(this);
}
...
_esm5.Observable.prototype.windowCount = windowCount_1.windowCount;
...
function windowTime(windowTimeSpan) {
    ...
    var windowCreationInterval = null;
    var maxWindowSize = Number.POSITIVE_INFINITY;
    if (internalCompatibility.isScheduler(arguments[3])) {
        scheduler = arguments[3];
    }
    if (internalCompatibility.isScheduler(arguments[2])) {
        scheduler = arguments[2];
    }
    else if (internalCompatibility.isNumeric(arguments[2])) {
        maxWindowSize = arguments[2];
    }
    if (internalCompatibility.isScheduler(arguments[1])) {
        scheduler = arguments[1];
    }
    else if (internalCompatibility.isNumeric(arguments[1])) {
        windowCreationInterval = arguments[1];
    }
    return operators.windowTime(windowTimeSpan, windowCreationInterval, maxWindowSize, scheduler)(this);
}
...
_esm5.Observable.prototype.windowTime = windowTime_1.windowTime;
 ...
 */
function windowToggle(openings, closingSelector) {
    return operators.windowToggle(openings, closingSelector)(this);
}
...
_esm5.Observable.prototype.windowToggle = windowToggle_1.windowToggle;
 ...
 */
function windowWhen(closingSelector) {
    return operators.windowWhen(closingSelector)(this);
}
...
_esm5.Observable.prototype.windowWhen = windowWhen_1.windowWhen;
...
function withLatestFrom() {
    ...
    return operators.withLatestFrom.apply(void 0, args)(this);
}
...
_esm5.Observable.prototype.withLatestFrom = withLatestFrom_1.withLatestFrom;

});

unwrapExports(withLatestFrom$2);

var zip$4 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
function zipProto() {
    ...
    return this.lift.call(_esm5.zip.apply(void 0, [this].concat(observables)));
}
...
unwrapExports(zip$4);
var zip_1 = zip$4.zipProto;

var zip$6 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });


_esm5.Observable.prototype.zip = zip$4.zipProto;
 ...
 */
function zipAll(project) {
    return operators.zipAll(project)(this);
}
...
_esm5.Observable.prototype.zipAll = zipAll_1.zipAll;
...
exports.Observable = _esm5.Observable;
exports.Subject = _esm5.Subject;

exports.AnonymousSubject = internalCompatibility.AnonymousSubject;
/* tslint:enable:no-unused-variable */
var internal_compatibility_2 = internalCompatibility;
...
exports.TestScheduler = testing.TestScheduler;
var rxjs_3 = _esm5;
...
exports.AjaxResponse = ajax$1.AjaxResponse;
exports.AjaxError = ajax$1.AjaxError;
exports.AjaxTimeoutError = ajax$1.AjaxTimeoutError;
var rxjs_4 = _esm5;
var internal_compatibility_3 = internalCompatibility;
var internal_compatibility_4 = internalCompatibility;
...
unwrapExports(Rx);
var Rx_1 = Rx.Observable;
var Rx_2 = Rx.Subject;
var Rx_3 = Rx.AnonymousSubject;
var Rx_4 = Rx.config;
var Rx_5 = Rx.Subscription;
var Rx_6 = Rx.ReplaySubject;
var Rx_7 = Rx.BehaviorSubject;
var Rx_8 = Rx.Notification;
var Rx_9 = Rx.EmptyError;
var Rx_10 = Rx.ArgumentOutOfRangeError;
var Rx_11 = Rx.ObjectUnsubscribedError;
var Rx_12 = Rx.UnsubscriptionError;
var Rx_13 = Rx.pipe;
var Rx_14 = Rx.TestScheduler;
var Rx_15 = Rx.Subscriber;
var Rx_16 = Rx.AsyncSubject;
var Rx_17 = Rx.ConnectableObservable;
var Rx_18 = Rx.TimeoutError;
var Rx_19 = Rx.VirtualTimeScheduler;
var Rx_20 = Rx.AjaxResponse;
var Rx_21 = Rx.AjaxError;
var Rx_22 = Rx.AjaxTimeoutError;
var Rx_23 = Rx.TimeInterval;
var Rx_24 = Rx.Timestamp;
var Rx_25 = Rx.operators;
var Rx_26 = Rx.Scheduler;
var Rx_27 = Rx.Symbol;

var Rx$2 = createCommonjsModule(function (module, exports) {
function __export(m) {
